...
const sidebars = {
  nodeSidebar: [
    ...
    "libraries/node/v1.0.0/loan_precalculation",
  ...
  phpSidebar: [
    "libraries/php/v2.0.0/index",
    "libraries/php/v2.0.0/available_methods",
    "libraries/php/v2.0.0/create_payment",
    "libraries/php/v2.0.0/process_payment",
    "libraries/php/v2.0.0/chargeback",
    "libraries/php/v2.0.0/save_card",
    "libraries/php/v2.0.0/pre_authorization",
