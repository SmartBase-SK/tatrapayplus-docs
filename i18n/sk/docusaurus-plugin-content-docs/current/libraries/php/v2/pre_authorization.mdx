...
import createPaymentPreAuthorization from '!!raw-loader!@site/code_samples/php/v2/create_payment_pre_authorization.php';
...
Ak obchodník vykoná transakciu predautorizácie za účelom [registrácie karty pre ComfortPay](/docs/libraries/php/v2/save_card), transakcia nebude zúčtovaná a bude držiteľovi karty uvoľnená bankou držiteľa karty v priebehu niekoľkých dní.
...
import confirmCancelPreAuthorization from '!!raw-loader!@site/code_samples/php/v2/confirm_cancel_pre_authorization.php';
