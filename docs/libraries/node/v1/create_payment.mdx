...
If your application serves multiple locales with distinct URIs—for example, https://example.com for one locale and https://example.com/de/ for German users—you must register both URIs in the developer portal.
